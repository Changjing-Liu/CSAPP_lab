...
00000000004017a8 <getbuf>:
  4017a8:	48 83 ec 28          	sub    $0x28,%rsp                 ;allocate 40 byte
  4017ac:	48 89 e7             	mov    %rsp,%rdi                  ;%rdi=%rsp
  4017af:	e8 8c 02 00 00       	callq  401a40 <Gets>              ;get
  4017b4:	b8 01 00 00 00       	mov    $0x1,%eax                  ;%eax=1
  4017b9:	48 83 c4 28          	add    $0x28,%rsp                 ;%rsp+=24 byte
  4017bd:	c3                   	retq   
  4017be:	90                   	nop
  4017bf:	90                   	nop
...
00000000004017ec <touch2>:
  4017ec:	48 83 ec 08          	sub    $0x8,%rsp                   ;allocate 8byte
  4017f0:	89 fa                	mov    %edi,%edx                   ;%edx=%edi
  4017f2:	c7 05 e0 2c 20 00 02 	movl   $0x2,0x202ce0(%rip)        # 6044dc <vlevel>
  4017f9:	00 00 00 
  4017fc:	3b 3d e2 2c 20 00    	cmp    0x202ce2(%rip),%edi        # 6044e4 <cookie>    compare %edi:2
...
00000000004018fa <touch3>:
  4018fa:	53                   	push   %rbx                       ;push
  4018fb:	48 89 fb             	mov    %rdi,%rbx                  ;%rbx=%rdx
  4018fe:	c7 05 d4 2b 20 00 03 	movl   $0x3,0x202bd4(%rip)        # 6044dc <vlevel>
  401905:	00 00 00 
  401908:	48 89 fe             	mov    %rdi,%rsi                  ;%rsi=%rdi
  40190b:	8b 3d d3 2b 20 00    	mov    0x202bd3(%rip),%edi        # 6044e4 <cookie>  store cookie内容
  401911:	e8 36 ff ff ff       	callq  40184c <hexmatch>
  401916:	85 c0                	test   %eax,%eax                  ;%rax refers to return value
...
0000000000401968 <test>:
  401968:	48 83 ec 08          	sub    $0x8,%rsp                 ;allocate 8 byte
  40196c:	b8 00 00 00 00       	mov    $0x0,%eax                 ;%eax=0
  401971:	e8 32 fe ff ff       	callq  4017a8 <getbuf>           ;goto 4017a8
  401976:	89 c2                	mov    %eax,%edx                 ;%edx=%eax
  401978:	be 88 31 40 00       	mov    $0x403188,%esi            ;%esi=0x403188
  40197d:	bf 01 00 00 00       	mov    $0x1,%edi                 ;%edi=1
  401982:	b8 00 00 00 00       	mov    $0x0,%eax                 ;%eax=0
  401987:	e8 64 f4 ff ff       	callq  400df0 <__printf_chk@plt>
  40198c:	48 83 c4 08          	add    $0x8,%rsp                 ;allocate 8 byte
  401990:	c3                   	retq   
  401991:	90                   	nop
  401992:	90                   	nop
  401993:	90                   	nop
