...
0000000000400f43 <phase_3>:
  ...
  400f91:	b8 85 01 00 00       	mov    $0x185,%eax                  ;loc_d;%eax=389
  400f96:	eb 26                	jmp    400fbe <phase_3+0x7b>        ;goto done
  400f98:	b8 ce 00 00 00       	mov    $0xce,%eax                   ;loc_e;%eax=260
  400f9d:	eb 1f                	jmp    400fbe <phase_3+0x7b>        ;goto done
  400f9f:	b8 aa 02 00 00       	mov    $0x2aa,%eax                  ;loc_f;%eax=682
  400fa4:	eb 18                	jmp    400fbe <phase_3+0x7b>        ;goto done
  400fa6:	b8 47 01 00 00       	mov    $0x147,%eax                  ;loc_g;%eax=327
  400fab:	eb 11                	jmp    400fbe <phase_3+0x7b>        ;goto done
  400fad:	e8 88 04 00 00       	callq  40143a <explode_bomb>        
  400fb2:	b8 00 00 00 00       	mov    $0x0,%eax      
  400fb7:	eb 05                	jmp    400fbe <phase_3+0x7b>        ;
  400fb9:	b8 37 01 00 00       	mov    $0x137,%eax
  400fbe:	3b 44 24 0c          	cmp    0xc(%rsp),%eax               ;%eax:M[%rsp+12](第四个数字)
  400fc2:	74 05                	je     400fc9 <phase_3+0x86>        ;if ==,goto 400fc9
  400fc4:	e8 71 04 00 00       	callq  40143a <explode_bomb>        ;
  400fc9:	48 83 c4 18          	add    $0x18,%rsp                   ;释放栈
  400fcd:	c3                   	retq   
答案：0 207

0000000000400fce <func4>:
  400fce:	48 83 ec 08          	sub    $0x8,%rsp                    ;allocate 8 byte
  ...
  400fe2:	39 f9                	cmp    %edi,%ecx                    ;compare %ecx:%edi
  400fe4:	7e 0c                	jle    400ff2 <func4+0x24>          ;if <=,goto 400ff2
  400fe6:	8d 51 ff             	lea    -0x1(%rcx),%edx              ;%edx=%rcx-1
  400fe9:	e8 e0 ff ff ff       	callq  400fce <func4>               ;goto func4()
  400fee:	01 c0                	add    %eax,%eax                    ;%eax=2*%eax
  400ff0:	eb 15                	jmp    401007 <func4+0x39>          ;goto done
  400ff2:	b8 00 00 00 00       	mov    $0x0,%eax                    ;%eax=0
  400ff7:	39 f9                	cmp    %edi,%ecx                    ;compare %ecx:%edi
  400ff9:	7d 0c                	jge    401007 <func4+0x39>          ;if >=,goto done
  400ffb:	8d 71 01             	lea    0x1(%rcx),%esi               ;%esi=%rcx+1;
  400ffe:	e8 cb ff ff ff       	callq  400fce <func4>               ;goto func4()
  401003:	8d 44 00 01          	lea    0x1(%rax,%rax,1),%eax        ;%eax
  401007:	48 83 c4 08          	add    $0x8,%rsp
  40100b:	c3                   	retq   

000000000040100c <phase_4>:
  40100c:	48 83 ec 18          	sub    $0x18,%rsp                     ;allocate 24 byte
  ...
  401029:	83 f8 02             	cmp    $0x2,%eax                      ;comepare %eax:2
  40102c:	75 07                	jne    401035 <phase_4+0x29>          ;if !=,goto 401035,bomb!!!
  40102e:	83 7c 24 08 0e       	cmpl   $0xe,0x8(%rsp)                 ;cpmare [%rsp+8]:14
  401033:	76 05                	jbe    40103a <phase_4+0x2e>          ;if <=,goto 40103a
  ...
  401044:	8b 7c 24 08          	mov    0x8(%rsp),%edi                 ;%edi=[%rsp+8]=%rdx
  401048:	e8 81 ff ff ff       	callq  400fce <func4>                 ;goto func4
  40104d:	85 c0                	test   %eax,%eax                      ;test %eax (return)
  40104f:	75 07                	jne    401058 <phase_4+0x4c>          ;if !=0,goto 401058,bomb!!
  401051:	83 7c 24 0c 00       	cmpl   $0x0,0xc(%rsp)                 ;comapre [%rsp+12]:0
  401056:	74 05                	je     40105d <phase_4+0x51>          ;if ==,goto 40105d
  401058:	e8 dd 03 00 00       	callq  40143a <explode_bomb>
  40105d:	48 83 c4 18          	add    $0x18,%rsp                     ;
  401061:	c3                   	retq   
答案：7 0
0000000000401062 <phase_5>:
  401062:	53                   	push   %rbx                           ;push rbx=0
  401063:	48 83 ec 20          	sub    $0x20,%rsp                     ;allocate 32 byte
  401067:	48 89 fb             	mov    %rdi,%rbx                      ;%rbx=%rdi  需要知道rbx是多少rbx=6305984,应该是一个数组的首地址,即s
  40106a:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax                  ;
  401071:	00 00 
  401073:	48 89 44 24 18       	mov    %rax,0x18(%rsp)                ;%rsp+24=%rax，栈上面存了点东西
  401078:	31 c0                	xor    %eax,%eax                      ;%eax^%eax----->%eax=0
  40107a:	e8 9c 02 00 00       	callq  40131b <string_length>         ;string_length() //猜测是字符串长度必须是6？ char类型？
  40107f:	83 f8 06             	cmp    $0x6,%eax                      ;compare %eax:6
  401082:	74 4e                	je     4010d2 <phase_5+0x70>          ;if ==, goto 4010d2
  401084:	e8 b1 03 00 00       	callq  40143a <explode_bomb>          ;bomb!!!
  401089:	eb 47                	jmp    4010d2 <phase_5+0x70>          ;goto 4010d2
  40108b:	0f b6 0c 03          	movzbl (%rbx,%rax,1),%ecx             ;%ecx=%rbx+%rax，访问s[i] %ecx为%rcx的低32位，4个字节
  40108f:	88 0c 24             	mov    %cl,(%rsp)                     ;M[%rsp]=%c1   %cl为%rcx的低8位，1个字节，char就是1个字节
  401092:	48 8b 14 24          	mov    (%rsp),%rdx                    ;%rdx=M[%rsp] 此时%dl是对的，前多位的数据不对
  401096:	83 e2 0f             	and    $0xf,%edx                      ;%edx=%edx&0xf,保留后四位
  401099:	0f b6 92 b0 24 40 00 	movzbl 0x4024b0(%rdx),%edx            ;%edx=0x4024b0+%rdx, 0x4024b0为首地址的数组s[m,a,d,u,i,e,r,s,n,f,o,t,v,b,y,l]
  4010a0:	88 54 04 10          	mov    %dl,0x10(%rsp,%rax,1)          ;M[10+%rsp+%rax]=%dl，将上面的保存在，，，中
  4010a4:	48 83 c0 01          	add    $0x1,%rax                      ;%rax=%rax+1;
  4010a8:	48 83 f8 06          	cmp    $0x6,%rax                      ;compare %rax:6,可以看得出，这里有一个循环，用for表示
  4010ac:	75 dd                	jne    40108b <phase_5+0x29>          ;if !=,goto 40108b
  4010ae:	c6 44 24 16 00       	movb   $0x0,0x16(%rsp)                ;M[%rsp+22]=0; 存储到%rsp+10+6
  4010b3:	be 5e 24 40 00       	mov    $0x40245e,%esi                 ;%esi=$0x40245e,可能是一个结构体的首地址   [f,l,y,e,r,s]
  4010b8:	48 8d 7c 24 10       	lea    0x10(%rsp),%rdi                ;%rdi=10+%rsp，，，数组首地址
  4010bd:	e8 76 02 00 00       	callq  401338 <strings_not_equal>     ;
  4010c2:	85 c0                	test   %eax,%eax                      ;test %eax
  4010c4:	74 13                	je     4010d9 <phase_5+0x77>          ;if ==0,goto 4010d9
  4010c6:	e8 6f 03 00 00       	callq  40143a <explode_bomb>
  4010cb:	0f 1f 44 00 00       	nopl   0x0(%rax,%rax,1)
  4010d0:	eb 07                	jmp    4010d9 <phase_5+0x77>
  4010d2:	b8 00 00 00 00       	mov    $0x0,%eax                      ;%eax=0,用符号表示i
  4010d7:	eb b2                	jmp    40108b <phase_5+0x29>          ;goto 40108b
  4010d9:	48 8b 44 24 18       	mov    0x18(%rsp),%rax                ;释放              
...
00000000004010f4 <phase_6>:
  ...
  4010fa:	55                   	push   %rbp
  4010fb:	53                   	push   %rbx
  4010fc:	48 83 ec 50          	sub    $0x50,%rsp                   ;allocate 80 byte
  401100:	49 89 e5             	mov    %rsp,%r13                    ;%r13=%rsp
  401103:	48 89 e6             	mov    %rsp,%rsi                    ;%rsi=%rsp
  401106:	e8 51 03 00 00       	callq  40145c <read_six_numbers>    ;read 6 numbers     %rdx:n1,%rcx:n2,%r8:n3,%r9:n4,%rsp:n5,%rsp+8:n6,共六个数字
  40110b:	49 89 e6             	mov    %rsp,%r14                    ;%r14=%rsp        取第一个数字
  40110e:	41 bc 00 00 00 00    	mov    $0x0,%r12d                   ;%r12d=0          j=0;
  401114:	4c 89 ed             	mov    %r13,%rbp                    ;%rbp=%r13=%rsp   第一层循环&n[i]
  401117:	41 8b 45 00          	mov    0x0(%r13),%eax               ;%eax=[0+%r13]    取n[i]
  40111b:	83 e8 01             	sub    $0x1,%eax                    ;%eax=eax-1       n[i]--
  40111e:	83 f8 05             	cmp    $0x5,%eax                    ;comapre %eax:5   如果n[i]<=5，bomb
  401121:	76 05                	jbe    401128 <phase_6+0x34>        ;if <=,goto 401128
  401123:	e8 12 03 00 00       	callq  40143a <explode_bomb>
  401128:	41 83 c4 01          	add    $0x1,%r12d                   ;r12d=r12d+1;      j=j+1
  40112c:	41 83 fc 06          	cmp    $0x6,%r12d                   ;compare r12d:6   比较j==6
  401130:	74 21                	je     401153 <phase_6+0x5f>        ;if ==,goto 401153
  401132:	44 89 e3             	mov    %r12d,%ebx                   ;%ebx=%r12d       相当于j
  401135:	48 63 c3             	movslq %ebx,%rax                    ;%rax=%ebx        相当于j
  401138:	8b 04 84             	mov    (%rsp,%rax,4),%eax           ;%eax=n[%rsp+4*rax]   取数字,从第二个开始取
  40113b:	39 45 00             	cmp    %eax,0x0(%rbp)               ;compare [0+%rbp]:%eax     与第一个数字比较，不同则跳过bomb
  40113e:	75 05                	jne    401145 <phase_6+0x51>        ;if !=,goto 401145
  401140:	e8 f5 02 00 00       	callq  40143a <explode_bomb>        
  401145:	83 c3 01             	add    $0x1,%ebx                    ;%ebx=%ebx+1       j++
  401148:	83 fb 05             	cmp    $0x5,%ebx                    ;compare %ebx:5    i和5比较,,,,,           循环
  40114b:	7e e8                	jle    401135 <phase_6+0x41>        ;if <=,goto 401135
  40114d:	49 83 c5 04          	add    $0x4,%r13                    ;%r13+=4   存的是地址，右移一位int,&n[i++]
  401151:	eb c1                	jmp    401114 <phase_6+0x20>        ;goto 401114                          第二层循环,每个数字不一样，每个数字小于等于6
  401153:	48 8d 74 24 18       	lea    0x18(%rsp),%rsi              ;%rsi=%rsp+24       最后一个数字的地址      
  401158:	4c 89 f0             	mov    %r14,%rax                    ;%rax=%r14          第一个数字的地址     
  40115b:	b9 07 00 00 00       	mov    $0x7,%ecx                    ;%ecx=7
  401160:	89 ca                	mov    %ecx,%edx                    ;%edx=%ecx          a=7
  401162:	2b 10                	sub    (%rax),%edx                  ;%edx=%edx-[%rax]   a=a-n[0]
  401164:	89 10                	mov    %edx,(%rax)                  ;[%rax]=%rdx        n[0]=a
  401166:	48 83 c0 04          	add    $0x4,%rax                    ;%rax+=4            地址移到下一个数字
  40116a:	48 39 f0             	cmp    %rsi,%rax                    ;compare %rax:%rsi  比较是否到最后一个数字，，，，，以上代码表示所有数字被7相减
  40116d:	75 f1                	jne    401160 <phase_6+0x6c>        ;if !=, goto 401160
  40116f:	be 00 00 00 00       	mov    $0x0,%esi                    ;%esi=0             rsi=0
  ...
  40117f:	75 f5                	jne    401176 <phase_6+0x82>        ;if !=,goto 401176
  401181:	eb 05                	jmp    401188 <phase_6+0x94>        ;goto 401188
  401183:	ba d0 32 60 00       	mov    $0x6032d0,%edx               ;%edx=$0x6032d0               
  401188:	48 89 54 74 20       	mov    %rdx,0x20(%rsp,%rsi,2)       ;[32+%rsp+2*%rsi]=%rdx    同一个地址存在六个的地方
  40118d:	48 83 c6 04          	add    $0x4,%rsi                    ;%rsi+=4            移到下一个地址
  401191:	48 83 fe 18          	cmp    $0x18,%rsi                   ;compare %rsi:24    是否到第6个数字
  401195:	74 14                	je     4011ab <phase_6+0xb7>        ;if ==,goto 4011ab  如果到了第6个数字，跳出循环
  401197:	8b 0c 34             	mov    (%rsp,%rsi,1),%ecx           ;%ecx=[%rsp+%rsi]  取数字n[0]
  40119a:	83 f9 01             	cmp    $0x1,%ecx                    ;compare %ecx:1    与1比较
  40119d:	7e e4                	jle    401183 <phase_6+0x8f>        ;if <=,goto 401183 如果比小于等于1
  40119f:	b8 01 00 00 00       	mov    $0x1,%eax                    ;%eax=1
  4011a4:	ba d0 32 60 00       	mov    $0x6032d0,%edx               ;%edx=$0x6032d0
  4011a9:	eb cb                	jmp    401176 <phase_6+0x82>        ;goto 401176
  4011ab:	48 8b 5c 24 20       	mov    0x20(%rsp),%rbx              ;%rbx=[32+%rsp]    第1个
  4011b0:	48 8d 44 24 28       	lea    0x28(%rsp),%rax              ;%rax=[40+%rsp]    第2个
  4011b5:	48 8d 74 24 50       	lea    0x50(%rsp),%rsi              ;%rsi=[80+%rsp]    第6个 第7个？
  4011ba:	48 89 d9             	mov    %rbx,%rcx                    ;%rcx=%rbx         =$0x6032d0
  4011bd:	48 8b 10             	mov    (%rax),%rdx                  ;%rdx=[%rax]       [$0x6032d0]地址的值
  4011c0:	48 89 51 08          	mov    %rdx,0x8(%rcx)               ;[8+%rcx]=%rdx     [$0x6032d8]地址的值=[$0x6032d0]地址的值
  4011c4:	48 83 c0 08          	add    $0x8,%rax                    ;%rax+=8
  4011c8:	48 39 f0             	cmp    %rsi,%rax                    ;cpmare %rax:%rsi
  4011cb:	74 05                	je     4011d2 <phase_6+0xde>        ;if ==,goto 4011d2
  4011cd:	48 89 d1             	mov    %rdx,%rcx                    ;%rcx=%rdx
  4011d0:	eb eb                	jmp    4011bd <phase_6+0xc9>        ;goto 4011bd
  4011d2:	48 c7 42 08 00 00 00 	movq   $0x0,0x8(%rdx)               ;[8+%rdx]=0
  4011d9:	00 
  4011da:	bd 05 00 00 00       	mov    $0x5,%ebp                    ;%ebp=5
  4011df:	48 8b 43 08          	mov    0x8(%rbx),%rax               ;%rax=[8+%rbx]
  4011e3:	8b 00                	mov    (%rax),%eax                  ;%eax=[%rax]
  4011e5:	39 03                	cmp    %eax,(%rbx)                  ;comapre [%rbx]:%eax
  4011e7:	7d 05                	jge    4011ee <phase_6+0xfa>        ;if >=,goto 4011ee
  4011e9:	e8 4c 02 00 00       	callq  40143a <explode_bomb>      
  4011ee:	48 8b 5b 08          	mov    0x8(%rbx),%rbx               ;%rbx=[8+%rbx]
  4011f2:	83 ed 01             	sub    $0x1,%ebp                    ;%ebp-=1
  4011f5:	75 e8                	jne    4011df <phase_6+0xeb>        ;if !=,goto 4011df
  4011f7:	48 83 c4 50          	add    $0x50,%rsp                   ;free
  4011fb:	5b                   	pop    %rbx
  4011fc:	5d                   	pop    %rbp
...
000000000040131b <string_length>:                                   ;%rdi=0x6038c0，%rax=0,%rdx=5
  40131b:	80 3f 00             	cmpb   $0x0,(%rdi)                  ;compare [%rdi]:0 compare 1:0
  40131e:	74 12                	je     401332 <string_length+0x17>  ;if ==,goto 401332
  401320:	48 89 fa             	mov    %rdi,%rdx                    ;%rdx=%rdi    %rdx=0x6038c0
  401323:	48 83 c2 01          	add    $0x1,%rdx                    ;%rdx+=1      %rdx=0x6038c1
  401327:	89 d0                	mov    %edx,%eax                    ;%eax=%edx    %rax=0x0008C1
  401329:	29 f8                	sub    %edi,%eax                    ;%edi-=%eax   %edi=
  40132b:	80 3a 00             	cmpb   $0x0,(%rdx)                  ;compare [%rdx]:0
  40132e:	75 f3                	jne    401323 <string_length+0x8>   ;if!==, goto 401323
...
000000000040145c <read_six_numbers>:
  40145c:	48 83 ec 18          	sub    $0x18,%rsp         ;分配24位                       %rdx,%rcx,%r8,%r9,%rsp,%rsp+8
  401460:	48 89 f2             	mov    %rsi,%rdx          ; %rdx=%rsi，代表首位地址
  401463:	48 8d 4e 04          	lea    0x4(%rsi),%rcx     ;%rcx=%rsi+4，代表第2个数字
  401467:	48 8d 46 14          	lea    0x14(%rsi),%rax    ;%rax=%rsi+20 
  40146b:	48 89 44 24 08       	mov    %rax,0x8(%rsp)     ;%rsp+8=%rax（代表第6个数字）压栈
  401470:	48 8d 46 10          	lea    0x10(%rsi),%rax    ;%rax=%rsi+16
  401474:	48 89 04 24          	mov    %rax,(%rsp)        ;%rsp=%rax  （代表第5个数字）压栈
  401478:	4c 8d 4e 0c          	lea    0xc(%rsi),%r9      ;%r9=%rsi+12 代表第4个数字
  40147c:	4c 8d 46 08          	lea    0x8(%rsi),%r8      ;%r8=%rsi+8  代表第3个数字
  401480:	be c3 25 40 00       	mov    $0x4025c3,%esi     ;%esi=0x4025c
